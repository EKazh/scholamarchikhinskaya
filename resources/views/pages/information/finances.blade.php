...
@section('main')
@section('title', 'МКОУ "Маршихинская СОШ" | Финансово-хозяйственная деятельность')
<section>
    <div class="container py-5">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h1 class="h1">Финансово-хозяйственная деятельность</h1>
        </div>

        <div class="bg-light rounded-4 p-4 shadow-sm mb-5">
            <p>Финансово-хозяйственная деятельность школы включает в себя управление бюджетом, планирование и учет доходов и расходов, а также обеспечение эффективного использования материальных и финансовых ресурсов для достижения образовательных целей.</p>
        </div>
